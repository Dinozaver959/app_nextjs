...
contract testingForm is ERC721, ERC721Enumerable, Ownable {
    ...
    string private _baseURIextended = string(abi.encodePacked("https://easylaunchnft.com/api/", "testingForm", "/"));
