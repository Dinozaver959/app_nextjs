...
contract testAgain is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public immutable AMOUNT_FOR_DEVS=23;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("test Again", "tA", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
