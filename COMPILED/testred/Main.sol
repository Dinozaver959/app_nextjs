...
contract testred is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public immutable MAX_PER_ADDRESS_DURING_MINT_AUCTION=2;
  uint256 public immutable MAX_PER_ADDRESS_DURING_MINT_PUBLIC=2;
  uint256 public immutable MAX_PER_ADDRESS_DURING_MINT_ALLOWLIST=0;

  // max to mint in total
  uint256 public immutable AMOUNT_FOR_DEVS=7;
  uint256 public immutable AMOUNT_FOR_AUCTION=3;
  uint256 public immutable AMOUNT_FOR_ALLOWLIST=0;

  // mint prices
  uint256 public immutable MINT_PRICE_PUBLIC=0.013 ether;
  uint256 public immutable MINT_PRICE_ALLOWLIST=0 ether;

  // AUCTION CONFIGURATION
  uint256 public constant AUCTION_START_PRICE=0.012 ether;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("test red ", "100", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
