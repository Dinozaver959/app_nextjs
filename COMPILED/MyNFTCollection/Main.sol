...
contract MyNFTCollection is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public immutable MAX_PER_ADDRESS_DURING_MINT_ALLOWLIST=1;

  // max to mint in total
  uint256 public immutable AMOUNT_FOR_DEVS=1;
  uint256 public immutable AMOUNT_FOR_AUCTION=0;
  uint256 public immutable AMOUNT_FOR_ALLOWLIST=3;

  // mint prices
  uint256 public immutable MINT_PRICE_PUBLIC=0.1 ether;
  uint256 public immutable MINT_PRICE_ALLOWLIST=0.08 ether;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("My Collection", "MNFT", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
