...
contract rerere is ERC721, ERC721Enumerable, Ownable {
    ...
    string private _baseURIextended = string(abi.encodePacked("https://easylaunchnft.com/api/", "rerere", "/"));
    bytes32 private _allowListRoot;

    mapping(address => uint256) private _allowListClaimed;

    constructor() ERC721("Beer", "TT") {}
