...
contract auction is Ownable, ERC721A, ReentrancyGuard {
  ...
  // mint prices
  uint256 public immutable MINT_PRICE_PUBLIC=0.03 ether;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("auction", "aaa", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
