...
contract DStest4 is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public immutable MINT_PRICE_ALLOWLIST=0.077 ether;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("DS test 4", "dst4", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
