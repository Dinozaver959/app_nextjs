...
contract MyFirstNFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  // mint prices
  uint256 public immutable MINT_PRICE_PUBLIC=0.05 ether;
  uint256 public immutable MINT_PRICE_ALLOWLIST=0.03 ether;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("My First NFT", "FNFT", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
