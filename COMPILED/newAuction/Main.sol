...
contract newAuction is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public immutable MAX_PER_ADDRESS_DURING_MINT_PUBLIC=5;
  uint256 public immutable MAX_PER_ADDRESS_DURING_MINT_ALLOWLIST=0;

  // max to mint in total
  uint256 public immutable AMOUNT_FOR_DEVS=3;
  uint256 public immutable AMOUNT_FOR_AUCTION=10;
  uint256 public immutable AMOUNT_FOR_ALLOWLIST=0;

  // mint prices
  uint256 public immutable MINT_PRICE_PUBLIC=0 ether;
  ...
  uint256 public constant AUCTION_PRICE_CURVE_LENGTH=20 minutes;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("new Auction", "nA", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
