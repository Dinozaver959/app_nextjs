...
contract repeatTestBNB is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public immutable AMOUNT_FOR_ALLOWLIST=2;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("repeat test BNB", "tBNB", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
