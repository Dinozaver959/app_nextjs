...
contract testLinkInDashboard is Ownable, ERC721A, ReentrancyGuard {

  // supplies
  uint256 public immutable MAX_SUPPLY=2;
  ...
  // CONSTRUCTOR
  constructor() ERC721A("Dashboard Link", "DL", MAX_PER_ADDRESS_DURING_MINT_PUBLIC, MAX_SUPPLY){}
