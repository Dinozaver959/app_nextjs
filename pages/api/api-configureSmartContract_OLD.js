...
async function UpdateCollectionInMoralisDB(maxSupply, mintPrice, tokenName, tokenSymbol, collectionName, paymentOption) {  
...
async function UpdateSettingsFile(maxSupply, mintPrice, tokenName, tokenSymbol, collectionName, paymentOption) {
...
apiRoute.post(async (req, res) => {
    ...
    var maxSupply, mintPrice, tokenName, tokenSymbol, collectionName, userAccount, paymentOption;
    ...
    UpdateCollectionInMoralisDB(maxSupply, mintPrice,  tokenName, tokenSymbol, collectionName, paymentOption);
    UpdateSettingsFile(maxSupply, mintPrice,  tokenName, tokenSymbol, collectionName, paymentOption);
