...
import {GetDeployedCollectionNames} from '../../JS/DB-cloudFunctions'
...
apiRoute.get(async (req, res) => {     
    ...
    LogBackend("stopped at the api-getCollectionNames-deployed.js");
 
    const collectionNames = await GetDeployedCollectionNames(id);
