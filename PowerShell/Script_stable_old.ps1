...
copy (Join-Path "." "bytecode.txt") (Join-Path '..' 'COMPILED' 'bytecode.txt') -force
copy (Join-Path "." "abi.txt") (Join-Path '..' 'COMPILED' 'abi.txt') -force
...
move $pathToBytecode (Join-Path '..' 'COMPILED' 'bytecode.txt') -force
move $ABIfile (Join-Path '..' 'COMPILED' 'abi.txt') -force
