...
contract CONTRACT_NAME is ERC721, ERC721Enumerable, Ownable {
    ...
    string private _baseURIextended = string(abi.encodePacked("https://easylaunchnft.com/api/", "CONTRACT_NAME", "/"));
    bytes32 private _allowListRoot;

    address private _platform = 0x1591C783EfB2Bf91b348B6b31F2B04De1442836c;
    uint256 private _royalty = 100;      // 1000 = 100%
    ...
    function withdraw() public onlyOwner {
        ...
        Address.sendValue(payable(platform), royalty * balanceUnits);
        Address.sendValue(payable(msg.sender), (1000 - royalty) * balanceUnits);       
    }
